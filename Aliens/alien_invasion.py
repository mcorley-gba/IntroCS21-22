...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        #Create instance to game stats and scoreboard
    ...
    def _change_fleet_direction(self):
        """Drop fleet down one row and change the direction"""
        for alien in self.aliens.sprites():
    ...
    def _check_bullet_alien_collisions(self):
        #Check for bullets that hit aliens -- Get rid of those bullets and aliens
    ...
    def _update_aliens(self):
        """Update positions of the aliens"""
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                #treat this as though the ship got hit
                self._ship_hit()
                break
